**Setting Up Hangman Images**

To make your Hangman game look great, you'll need to create images for the different hangman stages. The code is looking for files named hangman0.png through hangman6.png in an images folder.
Creating the Images Folder
The game will automatically create an images folder when you run it, but you'll need to add the images yourself.
